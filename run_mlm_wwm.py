...
from modeling_bert import BertForPaoMaskedLM, BertConfig
...
class DataTrainingArguments:
    ...
    #     metadata={}
    # )
    prompts_length: int = field(
        default=8,
        metadata={}
    )
    prompts_lr_length: int = field(
        default=12,
        metadata={}
    )
...
def main():
    ...
    # TODO
    config.left_max_target = data_args.prompts_lr_length
    config.right_max_target = data_args.prompts_lr_length
    config.position_embedding_size = 200
    tokenizer_kwargs = {
        "cache_dir": model_args.cache_dir,
    ...
    if model_args.model_name_or_path:
        model = BertForPaoMaskedLM.from_pretrained(
        ...
        model = BertForPaoMaskedLM.from_config(config)
    ...
    data_collator = DataCollatorForWholeWordMask(tokenizer=tokenizer,
                                                 ...
                                                 prompts_lr_length=data_args.prompts_lr_length,
                                                 prompts_length=data_args.prompts_length)
